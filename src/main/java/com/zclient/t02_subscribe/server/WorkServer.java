...
public class WorkServer{  
     ...
     */  
    public WorkServer(String configPath,String serversPath,ServerData serverData,ZkClient zkClient, DBConfig initconfig){  
        ...
        this.dataListener = new IZkDataListener() {  
            ...
            public void handleDataChange(String dataPath, Object data) throws Exception {  
                ...
                DBConfig serverConfigLocal = (DBConfig)JSON.parseObject(retJson,DBConfig.class);  
                //更新配置  
     ...
     */  
    private void updateConfig(DBConfig serverConfig){  
